 ...
 *
 * Car는 가솔린으로 동작하는 자동차를 표현한 것이고, HybridCar는 가솔린과 전기로 동작하는 자동차를 표현한 것이다.
 * 그리고 HybridWaterCar는 가솔린과 전기뿐 아니라, 물도 동시에 연료로 사용할 수 있는 꿈의 자동차를 표현한 것이다.
...
class qu14_1 {
	public static void main(String[] args) {
		Car car1 = new Car(10);
		HybridCar car2 = new HybridCar(20, 30);
		HybridWaterCar car3 = new HybridWaterCar(40, 50, 60);

		System.out.println("car1.gasolineGauge: " + car1.gasolineGauge);
		System.out.println("car2.gasolineGauge: " + car2.gasolineGauge);
		System.out.println("car2.electricGauge: " + car2.electricGauge);
